...
elements(1).points = [points(1),points(2),points(3)];
elements(2).points = [points(1),points(3),points(4)];
elements(3).points = [points(3),points(2),points(4)];
elements(4).points = [points(2),points(1),points(4)];
edges(6) = Edge;
